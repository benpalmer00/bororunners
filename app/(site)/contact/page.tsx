    ...
    <section className="section-padding pt-24 md:pt-32">
      <div className="container-wide mx-auto">
        <AnimatedSection>
          <SectionHeading
            title="Get in Touch"
            subtitle="Questions about joining, events, sponsorship, or anything else? Drop us a message."
          />
        </AnimatedSection>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li>
                      {/* TODO: Ben to provide Instagram URL */}
                      <a
                        href="https://www.instagram.com/boro.runners"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 text-brand-gray-600 hover:text-brand-red transition-colors"
                      >
